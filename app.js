class App {
  ...
  addEventListeners() {
    ...
    this.$formCloseButton.addEventListener("click", (event) => {
      event.stopPropagation(); // method stop the event and execute the function
      this.closeForm();
    });
  ...
  openTooltip(event) {
    ...
    this.id = event.target.nextElementSibling.dataset.id; // gives the note div and access data property
  ...
  selectNote(event) {
    ...
    const [$noteTitle, $noteText] = $selectedNote.children; // .children gives a array of the elements
